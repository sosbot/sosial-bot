...
var tplInputTemplate = `<div class="col-xs-12" ><label for="%s">%s</label> <input type="text" class="form-control-lg" id="%s" name="%s" required size="%s" placeholder="%s" minlength="%s" maxlength="%s" title="%s"></div><br>`
var tplDateTemplate = `<div class="col-xs-12"><label for="%s">%s</label><input type="date"  class="form-control-lg" id="%s" name="%s" value="" min="1900-01-01" max="2030-12-31"></div><br>`
